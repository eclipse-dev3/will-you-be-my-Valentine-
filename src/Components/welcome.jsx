...
function Welcome() {
    ...
    return (
        <div className='flex flex-col justify-center items-center'>
            <h1 className='flex justify-center items-center gap-1.5'>
                <img src="https://media.tenor.com/W_4cIjlMTZsAAAAi/cc.gif" alt="" className='w-[20%] sm:w-[10%] rounded-lg' />
                <p className='text-5xl font-black text-white'>Yeah</p>
